...
<div class = "mesazhAdminit" style = "margin-top:50px;">
    ...
    <center> <h5> Shkruani mesazhin tek Profesoret: </h5> <br> </center>
    ...
    <textarea id = "tekstiAd" name = "tekstiAd" rows = "10" cols = "30">Shkruani mesazhin qe deshironi te dergoni Profesorit</textarea>
       ...
       <div class = "card" style = "width:400px; margin: 20px;">
          <div class = "card-body">
           <center>   
              ...
              <p class = "card-text"> <a href = "messageAdInfo.php?id=<?php echo $mesazhiAd['Id'] ?>"> info </a> </p> 
           </center>
          </div>
       </div> 
